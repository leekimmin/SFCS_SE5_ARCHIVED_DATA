...
for (var i = 0; i < add_cart.length; i++) {
    ...
    add.addEventListener("click", function (event) {
        ...
        var subTitle = product.getElementsByClassName("sub-title")[0].innerText
        var price = product.getElementsByClassName("price")[0].innerText;
        addItemToCart(title, subTitle, price, img);
        updatecart();
    })
}
function addItemToCart(title, subTitle, price, img) {
